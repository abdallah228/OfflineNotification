...
<div class="col-lg-8 col-sm-8 col-8">
    <strong class="text-info">{{ $notification->data['user_creator'] }}</strong>
    <div>
        <form method="get" action="{{ route('posts.show',$notification->data['post_id']) }}">
            <input type="hidden" name="singleNotification" id="" value="{{ $notification->id }}">
            <button type="submit">{{ $notification->data['title'] }}</button>
        </form>
    </div>
